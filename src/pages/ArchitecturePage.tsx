    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 space-y-6">
        ...
        <section className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg p-4 border border-primary/20">
          ...
          >
            <div>
              <h2 className="text-lg font-bold text-primary mb-1">📊 商業分析報告</h2>
              <p className="text-sm text-muted-foreground">查看完整的商業背景、市場分析與開發路線圖</p>
            </div>
            <ExternalLink className="text-primary group-hover:translate-x-1 transition-transform" size={20} />
          </Link>
        </section>
